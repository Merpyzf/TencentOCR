...
import com.merpyzf.common.helper.tencent_ocr.common.http.HttpConnection;
import com.merpyzf.common.helper.tencent_ocr.common.profile.ClientProfile;
import com.merpyzf.common.helper.tencent_ocr.common.profile.HttpProfile;
...
abstract public class AbstractClient {
    ...
    public String call(String action, String jsonPayload) throws TencentCloudSDKException {
        ...
        String signature = new String(Hex.encodeHex(Sign.hmac256(secretSigning, stringToSign)));
